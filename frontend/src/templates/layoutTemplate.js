export const layoutTemplate = `<!-- ===================== APP SHELL ===================== -->
...
<div class="flex items-center gap-3 text-xl font-bold">
  <img src="/logo.png" alt="DeepFake Analyzer Logo" class="h-8 w-8 object-contain" />
  <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-tertiary">DeepFake Analyzer</span>
</div>
</div>
<!-- New Analysis Button -->
<div class="px-6 mb-6">
