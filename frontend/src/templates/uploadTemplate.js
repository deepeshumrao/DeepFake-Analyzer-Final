export const uploadTemplate = `<!-- ===== UPLOAD PAGE ===== -->
...
<h2 class="text-2xl font-bold text-on-surface mb-2">How DeepFake Analyzer Works</h2>
...
<a href="#" class="text-on-surface-variant text-sm hover:text-on-surface hover:underline transition-colors">About DeepFake Analyzer (PDF)</a>
</div>
<!-- Privacy Column -->
<div>
<h3 class="text-lg font-bold mb-4 flex items-center gap-2">
...
<div class="mt-8 pt-6 border-t border-outline-variant/10 text-center text-xs text-on-surface-variant">
    © 2026 DeepFake Analyzer. All rights reserved.
  </div>
</footer>
</div>
</div>
